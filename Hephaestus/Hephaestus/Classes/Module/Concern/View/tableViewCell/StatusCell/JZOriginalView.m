...
- (void)setUpData
{
    JZStatus *status = _statusF.status;
    // 头像
...
- (void)setUpFrame
{
    ...
    CGSize timeSize = [NSString sizeWithFont:[UIFont systemFontOfSize:12] maxSize:CGSizeMake(MAXFLOAT, MAXFLOAT) text:status.created_at];
//    CGSize timeSize = [status.created_at sizeWithFont:[UIFont systemFontOfSize:12]];
    ...
    CGSize sourceSize = [NSString sizeWithFont:[UIFont systemFontOfSize:12] maxSize:CGSizeMake(MAXFLOAT, MAXFLOAT) text:status.source];
